    ...
    <section class="about-me  container">
		...
		<div class="about-me__content">
			<div class="about-me__image">
				<svg class="about-me__image-svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<div class="about-me__personal-info">
				<ul class="about-me__list">
					<li class="about-me__item">
						...
						<span class="about-me__item-text">Попов Максим Иванович</span>
					</li>
					<li class="about-me__item">
						<span class="about-me__item-title">Дата рождения: </span>
						<span class="about-me__item-text">14.08.1996</span>
					</li>
					<li class="about-me__item">
